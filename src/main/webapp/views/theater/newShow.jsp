        ...
        <div class="row">
            <form id="publishShow_form" action="#" enctype="multipart/form-data" style="font-size: 15px;margin-top: 15px">
                ...
                <div class="row form-group">
                    <div class="col-md-12">
                        <label>类型</label>
                        <select name="type" id="type" style="margin-left: 3%;width: 30%;height: 40px;line-height: 50px;border-radius: 6%" onchange="onInput()">
                        ...
                        <div class="showtime_div row">
                            <div class="col-md-8">
                                <div class="input-append date form_datetime">
                                    <input name="showtime" size="16" type="text" value="" readonly style="text-align:center;height: 40px;width: 100%">
